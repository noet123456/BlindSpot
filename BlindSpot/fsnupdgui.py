...
def mouse_click(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if view_mode == -1 and y > 80:
            ...
            if x < mid_x and y < mid_y: view_mode = 0      # Cam 1
            elif x >= mid_x and y < mid_y: view_mode = 1   # Cam 2
            elif x < mid_x and y >= mid_y: view_mode = 2   # Cam 3
            elif x >= mid_x and y >= mid_y: view_mode = 3  # Cam 4
